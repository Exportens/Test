...
from util import resnet18
from util import DistributionPoolingFilter
...
class Model(nn.Module):
    ...
    def __init__(self, num_classes=10, num_instances=32, num_features=32, num_bins=11, sigma=0.1):
        ...
        self._representation_transformation = RepresentationTransformation(num_features=num_features, num_bins=num_bins,
                                                                           num_classes=1)
